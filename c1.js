...
mc.regConsoleCmd("222", "封禁一个玩家", function (args) {
    if (args.length == 0)
...
mc.regPlayerCmd("444", "封禁一个玩家", function (pl, args) {
    if (args.length == 0)
...
mc.regConsoleCmd("33333", "解封一个玩家", function (args) {
    if (args.length == 0)
...
mc.regPlayerCmd("33336", "解封一个玩家", function (pl, args) {
    if (args.length == 0)
